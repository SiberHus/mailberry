...
<head>
	...
	$(document).ready(function() {
		...
		$("#main_datagrid").jqGrid({
			...
			colNames:['Actions','Server Name', 'SMTP Server', 'POP3 Server', 'Status', 'Created By', 'Created At'],
			colModel:[
				{name:'act', width:80, fixed: true, sortable:false, search:false},
				{name:'serverName', width:80, searchoptions:searchoptions.string},
				{name:'smtpServer', width:100, searchoptions:searchoptions.string},
				{name:'pop3Server', width:100, searchoptions:searchoptions.string},
		...
		$('#create_btn').click(function(){
			window.location.href='${PATH.mailServers}/create';
		});
	});
    </script>
</head>
