...
<head>
	...
	$(document).ready(function() {
		...
		$("#main_datagrid").jqGrid({
			...
			colNames:['Actions','Widget Name', 'Content URI', 'Status', 'Created By', 'Created At'],
			colModel:[
				{name:'act', width:80, fixed: true, sortable:false, search:false},
				{name:'name', width:80, searchoptions:searchoptions.string},
				{name:'contentUri', width:100, searchoptions:searchoptions.string},
		...
		$('#create_btn').click(function(){
			window.location.href='${PATH.dashboard}/widgets/create';
		});
	});
    </script>
</head>
