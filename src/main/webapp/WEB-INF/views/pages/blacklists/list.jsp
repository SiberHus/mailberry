...
<head>
	...
	$(document).ready(function() {
		...
		$("#main_datagrid").jqGrid({
			...
			colNames:['Actions','Email', 'Full Name', 'Reason', 'Created By', 'Created At'],
			colModel:[
				{name:'act', width:80, fixed: true, sortable:false, search:false},
				{name:'email', width:80, searchoptions:searchoptions.string},
				{name:'fullName', width:100, searchoptions:searchoptions.string},
				{name:'reason', width:100, searchoptions:searchoptions.string},
		...
		$('#create_btn').click(function(){
			window.location.href='${PATH.blacklists}/create';
		});
	});
    </script>
</head>
		...
		<article class="module width_full">
			<header>
				...
				<h3 class="tabs_involved">
					<img src="${ctx }/resources/images/icons/group_delete.png"/>
