...
<head>
	...
	$(document).ready(function() {
		...
		$("#main_datagrid").jqGrid({
			...
			colNames:['Actions','Page Name', 'Visits', 'Visibility', 'Created By', 'Created At'],
			colModel:[
				{name:'act', width:80, fixed: true, sortable:false, search:false},
				{name:'name', width:100, searchoptions:searchoptions.string},
				{name:'visitCount', width:50, searchoptions:searchoptions.number},
				{name:'visibility', width:60, searchoptions:searchoptions.string},
		...
		$('#create_btn').click(function(){
			window.location.href='${PATH.customPages}/create';
		});
	});
    </script>
</head>
