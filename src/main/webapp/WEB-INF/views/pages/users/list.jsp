...
<head>
	...
	$(document).ready(function() {
		...
		$("#main_datagrid").jqGrid({
			...
			colNames:['Actions','Username', 'Email', 'First Name', 'Last Name', 'Enabled', 'Created By', 'Created At'],
			colModel:[
				{name:'act', width:80, fixed: true, sortable:false, search:false},
				{name:'username', width:80, searchoptions:searchoptions.string},
				{name:'email', width:100, searchoptions:searchoptions.string},
				{name:'firstName', width:100, searchoptions:searchoptions.string},
				{name:'lastName', width:100, searchoptions:searchoptions.string},
				{name:'enabled', width:30, searchoptions:searchoptions.bool},
		...
		$('#create_btn').click(function(){
			window.location.href='${PATH.users}/create';
		});
	});
    </script>
</head>
