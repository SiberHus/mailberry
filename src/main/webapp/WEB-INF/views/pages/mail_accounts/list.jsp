...
<head>
	...
	$(document).ready(function() {
		...
		$("#main_datagrid").jqGrid({
			...
			colNames:['Actions','Display Name', 'Email', 'Server Name', 'Status', 'Created By', 'Created At'],
			colModel:[
				{name:'act', width:80, fixed: true, sortable:false, search:false},
				{name:'displayName', width:80, searchoptions:searchoptions.string},
				{name:'email', width:100, searchoptions:searchoptions.string},
				{name:'mailServer.serverName', width:100, searchoptions:searchoptions.string},
		...
		$('#create_btn').click(function(){
			window.location.href='${PATH.mailAccounts}/create';
		});
	});
    </script>
</head>
