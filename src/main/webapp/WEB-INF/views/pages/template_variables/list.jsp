...
<head>
	...
	$(document).ready(function() {
		...
		$("#main_datagrid").jqGrid({
			...
			colNames:['Actions','Variable Name', 'Variable Value', 'Status', 'Created By', 'Created At'],
			colModel:[
				{name:'act', width:80, fixed: true, sortable:false, search:false},
				{name:'name', width:80, searchoptions:searchoptions.string},
				{name:'value', width:100, searchoptions:searchoptions.string},
		...
		$('#create_btn').click(function(){
			window.location.href='${PATH.templateVariables}/create';
		});
	});
    </script>
</head>
		...
		<article class="module width_full">
			<header>
				...
				<h3 class="tabs_involved">
					<img src="${ctx }/resources/images/icons/page_white_code.png"/>
